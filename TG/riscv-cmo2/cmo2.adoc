...
* #The number of cache indices at each cache level available to each hart#
...
{reg:[
	...
	{ bits: 5,  name: 0x0 },
	{ bits: 3,  name: 0x2,   attr: ['CBO'] },
	{ bits: 5,  name: 'rs1', attr: ['index'] },
	{ bits: 12, name: 0x009, attr: ['CIO.CLEAN'] },
]}
....
...
{reg:[
	...
	{ bits: 3,  name: 0x2,   attr: ['CBO'] },
	{ bits: 5,  name: 'rs1', attr: ['index'] },
	{ bits: 12, name: 0x00A, attr: ['CIO.FLUSH'] },
]}
....
...
{reg:[
	...
	{ bits: 3,  name: 0x2,   attr: ['CBO'] },
	{ bits: 5,  name: 'rs1', attr: ['index'] },
	{ bits: 12, name: 0x008, attr: ['CIO.INVAL'] },
]}
....
